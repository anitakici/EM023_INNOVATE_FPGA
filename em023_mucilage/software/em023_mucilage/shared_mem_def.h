...
//#define WATER_1_SENSOR_VALUE   (0x140)
//#define WATER_2_SENSOR_VALUE   (0x144)
...
#define WATER_SENSOR_L_THRESH		(0x260)

#define WATER_I2C				   (0x300)
#define PH_SENSOR_VALUE				(0x304)
#define PHOSPHORUS_SENSOR_VALUE				(0x308)
#define NITROGEN_SENSOR_VALUE				(0x30C)
